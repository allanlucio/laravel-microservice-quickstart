...
class GenresHasCategoriesRule implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        foreach($this->genresId as $genreId){
            $categoryGenres = $this->getCategoryGenres($genreId);

            if(!$categoryGenres->count()){
                return false;
            }
            array_push($categoriesFound, ...$categoryGenres->pluck("category_id")->toArray());
        }
    ...
    protected function getCategoryGenres($genreId){
